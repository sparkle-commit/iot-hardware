...
# model = CRS106-1C-5S (adjust if a different unit is used for Rongkop_TB)
...
/ip address
add address=192.168.58.16/28 comment="to Access Point" interface=bridge \
    network=192.168.58.16
add address=192.168.252.26/30 comment="to FE-WONOSARIIM3:sfp1" interface=\
    sfp1 network=192.168.252.24
/ip dns
set servers=1.1.1.1,8.8.8.8
/ip route
add disabled=no distance=1 dst-address=0.0.0.0/0 gateway=192.168.252.25 \
